...
class AuthService:
    ...
    def sign_in(self, email: str, password: str,
        ...
        try:
            ...
            inst_id = self._current_user.institutionId
            if inst_id:
                self.fb.college_id = inst_id
                import config as _cfg
                _cfg.COLLEGE_ID = inst_id

            # Store refresh token + institutionId securely if "remember me"
    ...
    def try_restore_session(self) -> bool:
        ...
        # No gdc11 auto-restore — user must login properly with their Firebase account
        # so that the correct institutionId is resolved from Firestore.
        try:
